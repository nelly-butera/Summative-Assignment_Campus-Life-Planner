...
window.onload = function() {
    ...
    clearForm();       // Reset the form to Add New Task state
    showPage('form');  // Redirect user to the form page
    });

    document.getElementById('form-reset-btn').addEventListener('click', clearForm);
